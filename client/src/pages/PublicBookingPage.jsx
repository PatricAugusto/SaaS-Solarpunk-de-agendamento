      ...
      <PageContainer>
        <GlassPanel>
          ...
          {eventType.description && (
            <p style={{ marginTop: 10 }}>{eventType.description}</p>
          )}
        </GlassPanel>
        ...
        <GlassPanel>
          <h2
            ...
            style={{ fontSize: "0.8rem", marginBottom: 16 }}
          >
            Escolha o dia
          </h2>
          <DaysRow>
            ...
            <SlotsRow>
              {slots.map((slot) => (
                <NeonButton
                  key={slot.start}
                  $variant={
                    selectedSlot?.start === slot.start ? "green" : "cyan"
                  }
            ...
            <form onSubmit={handleConfirm} style={{ display: "grid", gap: 14 }}>
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setGuest({ ...guest, guestEmail: e.target.value })
                  }
                  required
                />
              </FormGroup>
